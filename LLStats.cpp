...
int main() {
    ...
    // Create a linked list of the numbers 0..numValues-1 0000
    ...
    cout << "traverse count: " << theList.getTraverseCount() << endl;

    cout << "Average number of nodes traversed per access (uniform): " << theList.getTraverseCount() / double(numAccesses) << endl;
    ...
    cout << "traverse count: " << theList.getTraverseCount() << endl;
    cout << "Average number of nodes traversed per access (normal): " << theList.getTraverseCount() / double(numAccesses) << endl;
} // end LinkedListStats
